<?php # [BlazeFolded]:{flux::icon.check}:{C:\CooperativeTraining\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/check.blade.php}:{1788158904} ?>
<?php # [BlazeFolded]:{flux::icon.minus}:{C:\CooperativeTraining\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/minus.blade.php}:{1788158904} ?>
<?php
if (!function_exists('_88fbca2d76e7616fdd8052f916b0eb6a')):
function _88fbca2d76e7616fdd8052f916b0eb6a($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH C:\CooperativeTraining\vendor\livewire\flux\src/../stubs/resources/views/flux/checkbox/indicator.blade.php ENDPATH**/ ?>