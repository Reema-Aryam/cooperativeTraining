<?php
if (!function_exists('_9f3a35c06cbf7015de8e3e451d3dbe4c')):
function _9f3a35c06cbf7015de8e3e451d3dbe4c($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if ($tooltip): ?>
    <?php if (!function_exists('_3bb50bb6223522f369859d45107de6ee')) { $__blaze->compile('C:\CooperativeTraining\vendor\livewire\flux\src/../stubs/resources/views/flux/tooltip/index.blade.php', $__blaze->compiledPath.'/3bb50bb6223522f369859d45107de6ee.php'); require $__blaze->compiledPath.'/3bb50bb6223522f369859d45107de6ee.php'; } ?>
...
<?php ob_start(); ?>
    ...
    <?php $__slots3bb50bb6223522f369859d45107de6ee['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots3bb50bb6223522f369859d45107de6ee); ?>
<?php _3bb50bb6223522f369859d45107de6ee($__blaze, $__attrs3bb50bb6223522f369859d45107de6ee, $__slots3bb50bb6223522f369859d45107de6ee, ['content', 'position', 'kbd'], [], $__this ?? (isset($this) ? $this : null)); ?>
