<?php
if (!function_exists('_2260da6fdccfc29facefd68bda5a151e')):
function _2260da6fdccfc29facefd68bda5a151e($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if (!function_exists('_9f3a35c06cbf7015de8e3e451d3dbe4c')) { $__blaze->compile('C:\CooperativeTraining\vendor\livewire\flux\src/../stubs/resources/views/flux/with-tooltip.blade.php', $__blaze->compiledPath.'/9f3a35c06cbf7015de8e3e451d3dbe4c.php'); require $__blaze->compiledPath.'/9f3a35c06cbf7015de8e3e451d3dbe4c.php'; } ?>
...
<?php ob_start(); ?>
    <?php if (!function_exists('_7e5f882162f76accab14148a02785866')) { $__blaze->compile('C:\CooperativeTraining\vendor\livewire\flux\src/../stubs/resources/views/flux/button-or-link-pure.blade.php', $__blaze->compiledPath.'/7e5f882162f76accab14148a02785866.php'); require $__blaze->compiledPath.'/7e5f882162f76accab14148a02785866.php'; } ?>
...
<?php _1497587018afcfd0406e426cf22814a1($__blaze, ['icon' => 'loading','variant' => $iconVariant,'class' => $iconClasses], [], ['variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _1497587018afcfd0406e426cf22814a1($__blaze, ['icon' => $iconTrailing,'variant' => $iconTrailingVariant,'class' => $iconTrailingClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
        <?php elseif ($iconTrailing): ?>
            <?php echo e($iconTrailing); ?>

        <?php endif; ?>
    <?php $__slots7e5f882162f76accab14148a02785866['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots7e5f882162f76accab14148a02785866); ?>
<?php _7e5f882162f76accab14148a02785866($__blaze, $__attrs7e5f882162f76accab14148a02785866, $__slots7e5f882162f76accab14148a02785866, ['type', 'attributes', 'dataFluxButton'], ['dataFluxButton' => 'data-flux-button'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?>
<?php $__slots9f3a35c06cbf7015de8e3e451d3dbe4c['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots9f3a35c06cbf7015de8e3e451d3dbe4c); ?>
<?php _9f3a35c06cbf7015de8e3e451d3dbe4c($__blaze, $__attrs9f3a35c06cbf7015de8e3e451d3dbe4c, $__slots9f3a35c06cbf7015de8e3e451d3dbe4c, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
