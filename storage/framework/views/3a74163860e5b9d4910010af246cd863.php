...
<?php _b323ea595aa8085869c59a0be72cd26d($__blaze, ['name' => 'email','label' => __('Email address'),'value' => old('email'),'type' => 'email','required' => true,'autofocus' => true,'autocomplete' => 'email','placeholder' => 'email@example.com'], [], ['label', 'value', 'required', 'autofocus'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php _b323ea595aa8085869c59a0be72cd26d($__blaze, ['name' => 'password','label' => __('Password'),'type' => 'password','required' => true,'autocomplete' => 'current-password','placeholder' => __('Password'),'viewable' => true], [], ['label', 'required', 'placeholder', 'viewable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            ...
            <!-- Remember Me -->
            <?php if (!function_exists('_f0a7c7d41a6a17ffadca00bfb8474114')) { $__blaze->compile('C:\CooperativeTraining\vendor\livewire\flux\src/../stubs/resources/views/flux/checkbox/index.blade.php', $__blaze->compiledPath.'/f0a7c7d41a6a17ffadca00bfb8474114.php'); require $__blaze->compiledPath.'/f0a7c7d41a6a17ffadca00bfb8474114.php'; } ?>
<?php $__blaze->pushData(['name' => 'remember','label' => __('Remember me'),'checked' => old('remember')]); ?>
<?php _f0a7c7d41a6a17ffadca00bfb8474114($__blaze, ['name' => 'remember','label' => __('Remember me'),'checked' => old('remember')], [], ['label', 'checked'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php endif; ?>
<?php /**PATH C:\CooperativeTraining\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>