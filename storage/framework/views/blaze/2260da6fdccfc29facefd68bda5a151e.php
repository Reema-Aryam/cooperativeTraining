<?php
if (!function_exists('__2260da6fdccfc29facefd68bda5a151e')):
function __2260da6fdccfc29facefd68bda5a151e($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if (!function_exists('__9f3a35c06cbf7015de8e3e451d3dbe4c')) { $__blaze->compile('C:\CooperativeTraining\vendor\livewire\flux\src/../stubs/resources/views/flux/with-tooltip.blade.php', $__blaze->compiledPath.'/9f3a35c06cbf7015de8e3e451d3dbe4c.php'); require $__blaze->compiledPath.'/9f3a35c06cbf7015de8e3e451d3dbe4c.php'; } ?>
<?php if (isset($__slots9f3a35c06cbf7015de8e3e451d3dbe4c)) { $__slotsStack9f3a35c06cbf7015de8e3e451d3dbe4c[] = $__slots9f3a35c06cbf7015de8e3e451d3dbe4c; } ?>
<?php if (isset($__attrs9f3a35c06cbf7015de8e3e451d3dbe4c)) { $__attrsStack9f3a35c06cbf7015de8e3e451d3dbe4c[] = $__attrs9f3a35c06cbf7015de8e3e451d3dbe4c; } ?>
<?php $__attrs9f3a35c06cbf7015de8e3e451d3dbe4c = ['attributes' => $attributes]; ?>
<?php $__slots9f3a35c06cbf7015de8e3e451d3dbe4c = []; ?>
<?php $__blaze->pushData($__attrs9f3a35c06cbf7015de8e3e451d3dbe4c); ?>
<?php ob_start(); ?>
    <?php if (!function_exists('__7e5f882162f76accab14148a02785866')) { $__blaze->compile('C:\CooperativeTraining\vendor\livewire\flux\src/../stubs/resources/views/flux/button-or-link-pure.blade.php', $__blaze->compiledPath.'/7e5f882162f76accab14148a02785866.php'); require $__blaze->compiledPath.'/7e5f882162f76accab14148a02785866.php'; } ?>
<?php if (isset($__slots7e5f882162f76accab14148a02785866)) { $__slotsStack7e5f882162f76accab14148a02785866[] = $__slots7e5f882162f76accab14148a02785866; } ?>
<?php if (isset($__attrs7e5f882162f76accab14148a02785866)) { $__attrsStack7e5f882162f76accab14148a02785866[] = $__attrs7e5f882162f76accab14148a02785866; } ?>
<?php $__attrs7e5f882162f76accab14148a02785866 = ['type' => $type,'attributes' => $attributes->class($classes),'dataFluxButton' => true]; ?>
<?php $__slots7e5f882162f76accab14148a02785866 = []; ?>
<?php $__blaze->pushData($__attrs7e5f882162f76accab14148a02785866); ?>
<?php ob_start(); ?>
        <?php if ($loading): ?>
            <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <?php if (!function_exists('__1497587018afcfd0406e426cf22814a1')) { $__blaze->compile('C:\CooperativeTraining\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/index.blade.php', $__blaze->compiledPath.'/1497587018afcfd0406e426cf22814a1.php'); require $__blaze->compiledPath.'/1497587018afcfd0406e426cf22814a1.php'; } ?>
<?php $__blaze->pushData(['icon' => 'loading','variant' => $iconVariant,'class' => $iconClasses]); ?>
<?php __1497587018afcfd0406e426cf22814a1($__blaze, ['icon' => 'loading','variant' => $iconVariant,'class' => $iconClasses], [], ['variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            </div>
        <?php endif; ?>
...
<?php __1497587018afcfd0406e426cf22814a1($__blaze, ['icon' => $iconLeading,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php __1497587018afcfd0406e426cf22814a1($__blaze, ['icon' => $iconTrailing,'variant' => $iconTrailingVariant,'class' => $iconTrailingClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        <?php elseif ($iconTrailing): ?>
            <?php echo e($iconTrailing); ?>

        <?php endif; ?>
    <?php $__slots7e5f882162f76accab14148a02785866['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots7e5f882162f76accab14148a02785866); ?>
<?php __7e5f882162f76accab14148a02785866($__blaze, $__attrs7e5f882162f76accab14148a02785866, $__slots7e5f882162f76accab14148a02785866, ['type', 'attributes', 'dataFluxButton'], ['dataFluxButton' => 'data-flux-button'], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack7e5f882162f76accab14148a02785866)) { $__slots7e5f882162f76accab14148a02785866 = array_pop($__slotsStack7e5f882162f76accab14148a02785866); } ?>
<?php if (! empty($__attrsStack7e5f882162f76accab14148a02785866)) { $__attrs7e5f882162f76accab14148a02785866 = array_pop($__attrsStack7e5f882162f76accab14148a02785866); } ?>
<?php $__blaze->popData(); ?>
<?php $__slots9f3a35c06cbf7015de8e3e451d3dbe4c['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots9f3a35c06cbf7015de8e3e451d3dbe4c); ?>
<?php __9f3a35c06cbf7015de8e3e451d3dbe4c($__blaze, $__attrs9f3a35c06cbf7015de8e3e451d3dbe4c, $__slots9f3a35c06cbf7015de8e3e451d3dbe4c, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack9f3a35c06cbf7015de8e3e451d3dbe4c)) { $__slots9f3a35c06cbf7015de8e3e451d3dbe4c = array_pop($__slotsStack9f3a35c06cbf7015de8e3e451d3dbe4c); } ?>
<?php if (! empty($__attrsStack9f3a35c06cbf7015de8e3e451d3dbe4c)) { $__attrs9f3a35c06cbf7015de8e3e451d3dbe4c = array_pop($__attrsStack9f3a35c06cbf7015de8e3e451d3dbe4c); } ?>
<?php $__blaze->popData(); ?>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH C:\CooperativeTraining\vendor\livewire\flux\src/../stubs/resources/views/flux/button/index.blade.php ENDPATH**/ ?>